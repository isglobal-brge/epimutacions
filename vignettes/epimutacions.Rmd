...
abstract: >
    An introductory guide to analysing DNA methylation data with R package `epimutacions`. The areas covered in this document are: installing the package, loading the data, identifying and annotating the epimutations and results visualization.  
...
```{r workflow, echo=FALSE, fig.cap="Input data workflow", out.width = '90%', fig.align='center'}
knitr::include_graphics("C:/Users/Leire/Documents/GitHub/epimutacions/fig/workflow.png")
```
...
We ar going to create two different datasets for further analysis, `case_samples` and `control_panel`: 
```{r}
