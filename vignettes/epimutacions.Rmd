...
The `epimutacions` package comes with a small `GenomicRatioSet` class dataset (`methy`) to show the capabilities of the implemented methods. The following lines shows how to load the data: 
...
The dataset is composed by case and control samples. So,  we are going to split the data for the following analysis:
...
Invoking `epi_parameters()` with no arguments returns a list of the default settings: 
...
+-----------------------+-----------------------------------------------------------------------------------------------------------------------+
| `adj_pvalue`          | For methods `manova` and  `mlm` it provides the adjusted p-value.<br>                                                 |
|                       | For method `barbosa`, `isoforest`, `qn` and `mahdistmcd` it is filled with `NA`.                                      |
+-----------------------+-----------------------------------------------------------------------------------------------------------------------+ 
